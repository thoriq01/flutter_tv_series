...
import 'package:dicoding_tv_series/data/models/movie_cast.dart' as _i13;
import 'package:dicoding_tv_series/data/models/movie_detail_model.dart' as _i4;
import 'package:dicoding_tv_series/data/models/movie_model.dart' as _i12;
import 'package:dicoding_tv_series/data/models/movie_table.dart' as _i15;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockMovieDataSource extends _i1.Mock implements _i11.MovieDataSource {
  MockMovieDataSource() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i6.Future<List<_i12.MovieModel>> getPopularMovies() => (super.noSuchMethod(
      ...
      as _i6.Future<List<_i12.MovieModel>>);
  @override
  _i6.Future<List<_i12.MovieModel>> getRecomendationsMovies(int? id) =>
  ...
  _i6.Future<List<_i12.MovieModel>> searchMovies(String? query) =>
      (super.noSuchMethod(Invocation.method(#searchMovies, [query]),
          ...
          as _i6.Future<List<_i12.MovieModel>>);
  @override
  _i6.Future<List<_i13.MovieCast>> getMovieCast(int? id) => (super.noSuchMethod(
          Invocation.method(#getMovieCast, [id]),
          returnValue: Future<List<_i13.MovieCast>>.value(<_i13.MovieCast>[]))
      as _i6.Future<List<_i13.MovieCast>>);
  @override
  String toString() => super.toString();
}
